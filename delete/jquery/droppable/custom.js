$(document).ready(function(){
	...
	$(".productPriceWrapRight a img").click(function() {
		document.getElementById('loader1').innerHTML = '<img src="../uploadfiles/loader.gif">';
	...
	$(".productPriceWrapRight1 a img").click(function() {
		...
		document.getElementById('loader2').innerHTML = '<img src="../uploadfiles/loader.gif">';		
	...
	$(".productPriceWrapRight2 a img").click(function() {
		document.getElementById('loader3').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight3 a img").click(function() {
		document.getElementById('loader4').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight4 a img").click(function() {
		document.getElementById('loader5').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight5 a img").click(function() {
		document.getElementById('loader6').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight6 a img").click(function() {
		document.getElementById('loader7').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight34 a img").click(function() {
		...
		document.getElementById('loader8').innerHTML = '<img src="../uploadfiles/loader.gif">';
	...
	$(".productPriceWrapRight35 a img").click(function() {
		document.getElementById('loader9').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];	
		$("#notificationsLoader").html('<img src="images/loader.gif">');
	...
	$(".productPriceWrapRight7 a img").click(function() {
		document.getElementById('loader10').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight8 a img").click(function() {
		document.getElementById('loader11').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight9 a img").click(function() {
		document.getElementById('loader12').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight10 a img").click(function() {
		document.getElementById('loader13').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight11 a img").click(function() {
		document.getElementById('loader14').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight12 a img").click(function() {
		document.getElementById('loader15').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
		...
		success: function(theResponse) {			
			if(productIDVal=='2' || productIDVal=='3' ){
	...
	$(".productPriceWrapRight13 a img").click(function() {
		document.getElementById('loader20').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight14 a img").click(function() {
		document.getElementById('loader28').innerHTML = '<img src="../uploadfiles/loader.gif">';		
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight15 a img").click(function() {
		document.getElementById('loader21').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight16 a img").click(function() {
		document.getElementById('loader22').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight17 a img").click(function() {
		document.getElementById('loader18').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight18 a img").click(function() {
		document.getElementById('loader19').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight19 a img").click(function() {
		document.getElementById('loader27').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight21 a img").click(function() {
		document.getElementById('loader29').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight22 a img").click(function() {
		document.getElementById('loader24').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight23 a img").click(function() {
		document.getElementById('loader25').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight24 a img").click(function() {
		document.getElementById('loader30').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight25 a img").click(function() {
		document.getElementById('loader31').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight26 a img").click(function() {
		document.getElementById('loader32').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight27 a img").click(function() {
		document.getElementById('loader33').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight29 a img").click(function() {
		document.getElementById('loader34').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight30 a img").click(function() {
		document.getElementById('loader35').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight31 a img").click(function() {
		document.getElementById('loader16').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight32 a img").click(function() {
		document.getElementById('loader17').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	$(".productPriceWrapRight33 a img").click(function() {
		document.getElementById('loader23').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
	...
	//Advance Annual Income Started	
	$("#basketItemsWrap36 li:first").hide();	
	$(".productPriceWrapRight36 a img").click(function() {
		document.getElementById('loader26').innerHTML = '<img src="../uploadfiles/loader.gif">';
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];
		...
		type: "POST",  
		url: "http://90.0.0.150/php/DemoMatrimony/english/droppable_function.php",  
		data: { productID: productIDVal, action: "addToAdvannincome", uid: userid},
		success: function(theResponse) {
			
			if( $("#advincID_" + productIDVal).length > 0){
				$("#advincID_" + productIDVal).animate({ opacity: 0 }, 500, function() {
					$("#advincID_" + productIDVal).before(theResponse).remove();
				});				
				$("#advincID_" + productIDVal).animate({ opacity: 0 }, 500);
				$("#advincID_" + productIDVal).animate({ opacity: 1 }, 500);
				$("#notificationsLoader").empty();			
			} else {
				$("#basketItemsWrap36 li:first").before(theResponse);
				$("#basketItemsWrap36 li:first").hide();
				$("#basketItemsWrap36 li:first").show("slow");  
				$("#notificationsLoader").empty();			
			}			
		}  
		});
	...
	$("#basketItemsWrap36 li img").live("click", function(event) { 														
		var productIDValSplitter 	= (this.id).split("_");
		var productIDVal 			= productIDValSplitter[1];
		var userid 					= productIDValSplitter[2];	
		$("#notificationsLoader").html('<img src="images/loader.gif">');	
		...
		type: "POST",  
		url: "http://90.0.0.150/php/DemoMatrimony/english/droppable_function.php",  
		data: { productID: productIDVal, action: "deleteFromAdvAnninc", uid: userid},  
		success: function(theResponse) {			
			$("#advincID_" + productIDVal).hide("slow",  function() {$(this).remove();});
			$("#notificationsLoader").empty();		
		}  
		});		
	});
	//Advance Annual Income ended
