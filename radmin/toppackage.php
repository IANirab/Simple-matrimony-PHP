...
$fromqry = "from tbldatingpackagemaster INNER JOIN  tbldatingpaymentdetail ON  tbldatingpackagemaster.PackageId=tbldatingpaymentdetail.packageid  AND  tbldatingpackagemaster.currentstatus=0  AND   tbldatingpackagemaster.CreateDate>='".$pastdate."' AND  tbldatingpackagemaster.CreateDate<='".$currentdate."' group by tbldatingpackagemaster.Description order by count(*) desc";
$FileNm = "topreligions.php?";
...
$result = getdata("select tbldatingpackagemaster.Description,count(*) $fromqry  $NoOfRecord ");
//$paxtotal = 0;
//$amnttotal = 0;
//$nighttotal = 0;
