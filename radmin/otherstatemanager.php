...
<div class="pagewrapper">
	<div class="container">
		...
		<div class="col-lg-9 center_right">
			<div id="center-in">
			<!-- ********* TITLE START HERE *********-->
			<h1 class="pagetitle">Disapprove State Manager</h1>
			<div class="addlink1">
			<?php /*?><?
...
$fromqry = " from tbldating_state_master where currentstatus in (5) ";
$fromqry .= $searchqry;
...
$result = getdata("select id,title,currentstatus,country_id ". $fromqry ." order by tbldating_state_master.title ". $NoOfRecord);
while($rs= mysqli_fetch_array($result))
{
			...
			$currentstatus=$rs[2];
			$country_id=$rs[3];
			if($country_id!='' && $country_id!='0.0')
			{
				$country_id=getonefielddata("select title from tbldatingcountrymaster where id=".$country_id."");
			}
			/*$imagenm=$rs[2];
			$language=$rs[3];
			if ($imagenm == "")
		 ...
		 ?>
            ...
            <td >
				...
				<a href="otherstatedelete.php?b=<?= $LocationId ?>" class="actionbtndel green">Approve</a>
