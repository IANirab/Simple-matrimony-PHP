...
{
	$action = $_GET["b"];
	$result = getdata("select title,languageid,state_id from tbldating_district_master where currentstatus =0 and id=$action");
...
<div class="pagewrapper">
	<div class="container">
		...
		<div class="col-lg-9 center_right">
			<div id="center-in">
			<!-- ********* TITLE START HERE *********-->
			<h1 class="pagetitle">Add District</h1>
			<!-- ********* TITLE END HERE *********-->
