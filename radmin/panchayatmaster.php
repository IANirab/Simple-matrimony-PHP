...
{
	$action = $_GET["b"];
	$result = getdata("select title,languageid,district_id from tbldating_panchayat_master where currentstatus =0 and id=$action");
...
<div class="pagewrapper">
	<div class="container">
		...
		<div class="col-lg-9 center_right">
			<div id="center-in">
			<!-- ********* TITLE START HERE *********-->
			<h1 class="pagetitle">Add Municipal / Panchayat</h1>
			<!-- ********* TITLE END HERE *********-->
...
<? fillcombo("select id,title from tbldating_city_master where currentstatus=0",$districtid,"Select"); ?>
</select>
              </div>  
		<? }else{?>
        <div class="widhtsetr control-label_25">
