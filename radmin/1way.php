...
<div class="pagewrapper">
	<div class="container">
		...
		<div id="center-in">
			<!-- ********* TITLE START HERE *********-->
			<h1 class="pagetitle" > <i class="fas fa-american-sign-language-interpreting"></i> All Members [1-way-]
		<!-- CENTER END ######################## -->
	</div>	
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
    <li>
    <a href="add1way.php?b=<? echo $data->userid; ?>" class="hvr-rectangle-out"> <i class="fas fa-share-square"></i> Send 1-way</a>
    </li>
    </td>
    </tr>
    <? } ?>
