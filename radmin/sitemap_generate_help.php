...
<div class="pagewrapper">
	<div class="container">
		...
		<div class="col-lg-9 center_right">
			<div id="center-in">
        <h1 class="pagetitle">Sitemap Generate Help
			...
			<div class="addlink1">	
                ...
                <a href="sitemap_generate.php" target="_blank">Run File</a>
                </div>
			</div>
			<!-- ********* TITLE END HERE *********-->
			<div id="pagecontent">
...
<h1>Sitemap following activites</h1>
<ul>
<li>1. All static/CMS pages include</li>
<li>2. user display page include </li>
<li>3. Change sitename - <?=$sitepath?>dbinclude/sitemap_function.php [$websitename]</li>
</ul>
</div>
<div class="cron_help_text">			
<h1>View Generated Sitemap Files :</h1>
<ul>
<li><i><a href="<?=$sitepath?>sitemap" target="_blank">View</a></i></li>
</ul>
</div>
