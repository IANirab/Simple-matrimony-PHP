...
//checkloginteam();
$page_name = "Monthly Female Registration";
...
?>     
  ...
  <h1>Monthly Female Registration Report <br> <?=$monthName?> - <?=$_POST['year']?> 
...
/*$fromqry = "from  tbldatingusermaster where currentstatus=0 and genderid=$action and DATE_FORMAT(createdate,'%Y-%m')='".date('Y-m')."' order by createdate asc";*/
