...
{
	$action = $_GET["b"];
	$result = getdata("select title,languageid,castid from tbldatingsubcastmaster where currentstatus =0 and id=$action");
...
<div class="pagewrapper">
	<div class="container">
		...
		<div class="col-lg-9 center_right">
			<div id="center-in">
			<!-- ********* TITLE START HERE *********-->
			<h1 class="pagetitle">Add Subcaste</h1>
			<!-- ********* TITLE END HERE *********-->
...
<? fillcombo("select id,title from tbldatingcastmaster where currentstatus=0 order by title ",$religianid,"Select"); ?>
</select>
              </div>
              </div>
