...
{
	$action = $_GET["b"];
	$result = getdata("select title,languageid,country_id,zone_id from tbldating_state_master where currentstatus =0 and id=$action");
...
<div class="pagewrapper">
	<div class="container">
		...
		<div class="col-lg-9 center_right">
			<div id="center-in">
			<!-- ********* TITLE START HERE *********-->
			<h1 class="pagetitle">Add State</h1>
			<!-- ********* TITLE END HERE *********-->
...
<? fillcombo("select id,title from tbldatingcountrymaster where currentstatus=0",$countryid,"Select"); ?>
</select>
              </div>
              </div>
         <div class="form-group">
     ...
     <label>Zone </label>
              <select name="cmbzoneid"  class="form-control">
<? fillcombo("select id,title from tbldatingzonemaster where currentstatus=0",$zoneid,"Select"); ?>
</select>
              </div><?php */?>
