...
<div class="pagewrapper">
	<div class="container">
		...
		<div class="col-lg-9 center_right">
			...
			?>
			<div class="addlink"><a href="statemaster.php">Add new state</a></div>
			<? } ?>
			</div>
			<!-- ********* TITLE END HERE *********-->
			<div id="pagecontent">
          <div class="form-wrapper">
            <form method="post" action="state_query.php" class="form_second" name="state">
...
$fromqry = " from tbldating_state_master where currentstatus in (0) ";
$fromqry .= $searchqry;
$FileNm = "statemanager.php?";
...
//echo "select id,title ". $fromqry ." order by tbldating_state_master.title ". $NoOfRecord; 
$result = getdata("select id,title ". $fromqry ." order by tbldating_state_master.title ". $NoOfRecord);
		 ...
		 ?>
            ...
            <td>
				<?
					if($location_mgmnt_lc_2 == 'Y' || $location_mgmnt_lc_2 == 'N') {
				?>
		    	<a href="statemaster.php?b=<?= $LocationId ?>" class="actionbtn_m green">Modify</a>
				<? } if($location_mgmnt_lc_4 == 'Y' || $location_mgmnt_lc_4 == 'N') {  ?>
				<a href="statedelete.php?b=<?= $LocationId ?>" class="actionbtndel">Delete</a>
				<? } ?>
            	</td>
            </tr>
		<?
