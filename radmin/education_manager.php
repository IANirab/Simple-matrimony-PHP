...
<div class="pagewrapper">
	<div class="container">
		...
		<div class="col-lg-9 center_right">
			<div id="center-in">
			<!-- ********* TITLE START HERE *********-->
			<h1 class="pagetitle">Education Manager</h1>
			<div class="addlink1">
			<?
			if($location_mgmnt_lc_2 == 'Y' || $location_mgmnt_lc_2 == 'N') {
			?>
			<div class="addlink"><a href="education_master.php">Add Education</a></div>
			<? } ?>
			</div>
			<!-- ********* TITLE END HERE *********-->
			<div id="pagecontent">
            <div class="form-wrapper">
            <form method="post" class="form_second" action="edu_query.php" name="cast">
           <div class="form-group">
<label> Search</label>
            
              
              <select name="cat_id" class="form-control">
<? fillcombo("select id,title from tbl_education_category_master where currentstatus=0","","Select Category"); ?>
</select>
</div>
 <div class="form-group">
 <label> &nbsp;</label>
...
$fromqry = " from tbl_education_master where currentstatus in (0) ";
$fromqry .= $searchqry;
$FileNm = "education_manager.php?";
...
$result = getdata("select id,title ". $fromqry ." order by tbl_education_master.id desc ". $NoOfRecord);
		 ...
		 ?>
            ...
            <td >
				<?
					if($location_mgmnt_lc_2 == 'Y' || $location_mgmnt_lc_2 == 'N') {
				?>
		    	<a href="education_master.php?b=<?= $LocationId ?>" class="actionbtn_m green">Modify</a>
				<? } if($location_mgmnt_lc_4 == 'Y' || $location_mgmnt_lc_4 == 'N') {  ?>
				<a href="education_delete.php?b=<?= $LocationId ?>" class="actionbtndel">Delete</a>
				<? } ?>
            	</td>
            </tr>
		<?
