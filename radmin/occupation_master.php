...
{
	$action = $_GET["b"];
	$result = getdata("select title from tbldatingoccupationmaster where currentstatus =0 and id=$action");
...
<div class="pagewrapper">
	<div class="container">
		...
		<div class="col-lg-9 center_right">
			<div id="center-in">
			<!-- ********* TITLE START HERE *********-->
			<h1 class="pagetitle">Add Occupation</h1>
			<!-- ********* TITLE END HERE *********-->
...
if($location_mgmnt_lc_2 == 'Y' || $location_mgmnt_lc_2 == 'N') { ?>
     ...
     <?php /*?><div class="form-group"><label>Category </label>
              <select name="cat_id"  class="form-control">
<? fillcombo("select id,title from tbl_occupation_category_master where currentstatus=0",$countryid,"Select"); ?>
