...
<div class="pagewrapper">
	<div class="container">
		...
		<div class="col-lg-9 center_right">
			...
			?>
			<div class="addlink"><a href="citymaster.php">Add new city</a></div>
			<? } ?>
			</div>
			<!-- ********* TITLE END HERE *********-->
			<div id="pagecontent">
            <div class="form-wrapper">
            <form method="post" class="form_second" action="city_query.php" name="country">
...
$fromqry = " from tbldating_city_master where currentstatus in (0,5) ";
$fromqry .= $searchqry;
...
$result = getdata("select id,title ". $fromqry ." order by tbldating_city_master.title ". $NoOfRecord);
//echo "select id,title ". $fromqry ." order by tbldating_city_master.title ". $NoOfRecord; 
		 ...
		 ?>
            ...
            <td>
				<?
					if($location_mgmnt_lc_2 == 'Y' || $location_mgmnt_lc_2 == 'N') {
				?>
		    	<a href="citymaster.php?b=<?= $LocationId ?>" class="actionbtn_m green">Modify</a>
				<? } if($location_mgmnt_lc_4 == 'Y' || $location_mgmnt_lc_4 == 'N') {  ?>
				<a href="citydelete.php?b=<?= $LocationId ?>" class="actionbtndel">Delete</a>
				<? } ?>
            	</td>
            </tr>
		<?
