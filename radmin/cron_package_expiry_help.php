...
<div class="pagewrapper">
	<div class="container">
		...
		<div class="col-lg-9 center_right">
			<div id="center-in">
        <h1 class="pagetitle">Package Expire Cron Help
			...
			<div class="addlink1">	
                ...
                <a href="cron_package_expiry.php">Run File</a>
                </div>
			</div>
			<!-- ********* TITLE END HERE *********-->
			<div id="pagecontent">
...
<ul>
<li>1. Check User Current Package </li>
<li>2. Send Email , if Expire days remain 10,5,1 </li>
...
Control from -> cron_package_expiry.php ($limit)<br></li>

<li>2. Cron File, use email template<br>
Control from -> tbldatingemailmaster (emailid=38)<br></li>

<li>3. Cron File, Entry of Email <br>
See in  -> tbl_cron_master_new (type=2)<br></li>
