...
<div class="pagewrapper">
	<div class="container">
		...
		<div id="center-in">
			<!-- ********* TITLE START HERE *********-->
			<h1 class="pagetitle" > <i class="fas fa-american-sign-language-interpreting"></i> Members Request for consultant
		<!-- CENTER END ######################## -->
	</div>	
...
<table class="table">
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">Selected Consultant</th>
  ...
  <tbody>
        ...
        $id="waiting";
        $sql = "select * from tbl_consultant_request where status='$id'";
        $result = $db->query($sql);
    ...
    <tr>
      ...
      <td><a href="https://www.paroshi.com/displayprofile.php?b=<? echo $data->userid; ?>"><? echo $data1->name; ?></a></td>
      <? } ?>
      
      <td><? echo $data->time; ?></td>
      <td><? echo $data->hours; ?></td>
      
        <? 
        $db2 = new mysqli("localhost","paroshic_paroshic","kxmcwQzLTrTR","paroshic_matri2018jl");
        $id=$data->conid;
        $sql2 = "select * from tbl_consultant_list where id='$id'";
        $result2 = $db2->query($sql2);
        
        while($data2 = $result2->fetch_object()){
            $skype_id=$data2->skype_id;
        ?>
...
if(isset($_GET['accept'])){
    ...
    $id1 = "accept";
        ...
        $sql6 = "select * from tbl_consultant_request where id='$accept'";
        ...
        $sql7 = "select * from tbldatingusermaster where userid='$userid'";
        $result7 = $db7->query($sql7);
        
        while($data7 = $result7->fetch_object()){
            
            $consultant2 = $data7->consultant;
    ...
    $db = new mysqli("localhost","paroshic_paroshic","kxmcwQzLTrTR","paroshic_matri2018jl");
    $sql = "UPDATE tbl_consultant_request SET
            skypeid = '$skype_id',
            status = '$id1'
    where id='$accept'";
...
?>
    ...
    <td>
    <a href="?accept=<? echo $data->id; ?>">  
    <button type="button" class="btn btn-primary">Accept</button>
    </a>
    <br>
    <a href="?delete=<? echo $data->id; ?>">
