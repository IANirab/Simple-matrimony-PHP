...
<div class="pagewrapper">
	<div class="container">
		...
		<div class="col-lg-9 center_right">
			<div id="center-in">
        <h1 class="pagetitle">Spam Detect Cron Help
			...
			<div class="addlink1">	
                ...
                <a href="cron_spam_detect.php">Run File</a>
                </div>
			</div>
			<!-- ********* TITLE END HERE *********-->
			<div id="pagecontent">
...
<ul>
<li>1. Check User Email & Password</li>
<li>2. if it's in block IP List it will automattically goes in spam list </li>
...
<h1>File Name</h1>
<ul>
<li><i>cron_spam_detect.php</i></li>
</ul>
</div>
...
<ul>
<li>
1.Cron File, check if min 30 same password are avalable <br>
Control from -> cron_spam_detect.php </li>
<li>
2.Cron File, check if min 30 same IP are avalable <br>
Control from -> cron_spam_detect.php </li>
<li>
</ul>
</div>
