...
<!-- TOP END ######################## -->
	<div id="content-wrap">
		...
		<div id="center">
			<div id="center-in">
			<!-- ********* TITLE START HERE *********-->
			<div id="pagetitle"><h1>sms Manager</h1>
			<div class="addlink1"><div class="addlink"><a href="sms_master.php">Add new</a></div></div></div>
			<!-- ********* TITLE END HERE *********-->
			<div id="pagecontent">
<!-- ********* CONTENT START HERE *********-->
...
<?php /*?><form name="searchkey" method="post" action="sms_search.php">
...
<form name="delall" method="post" action="sms_delete.php">
...
<table width="90%"  border="0" align="center" cellpadding="3" cellspacing="0" class="greytableborder">
        <tr>
  		<th scope="col">Id</th>
        <th scope='col' width='100'>mobile</th><th scope='col' width='100'>sms_text</th>
...
$fromqry = " from tbl_sms_master where currentstatus in (0) ".$searchqry." ".$ordby;
//$fromqry .= $searchqry;
$FileNm = "sms_manager.php?";
...
<?
$result = getdata("select id,mobile,sms_text $fromqry  $NoOfRecord ");
$j = 1;
...
<td <?= admintdclass ?>>
 ...
 <a href="sms_delete.php?b=<?= $id ?>" class="action">Delete</a>&nbsp;|
 <a href="resend.php?b=<?= $id ?>" class="action">Resend</a>
</td>
</tr>
<?
$j++;
