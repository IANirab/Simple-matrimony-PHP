...
<div class="pagewrapper">
	<div class="container">
		...
		<div class="col-lg-9 center_right">
			<div id="center-in">
			<!-- ********* TITLE START HERE *********-->
			<h1 class="pagetitle">District Manager</h1>
			<div class="addlink1">
			<?
			if($location_mgmnt_lc_2 == 'Y' || $location_mgmnt_lc_2 == 'N') {
			?>
			<div class="addlink"><a href="districtmaster.php">Add new district</a></div>
			<? } ?>
			</div>
			<!-- ********* TITLE END HERE *********-->
			<div id="pagecontent">
            <div class="form-wrapper">
            <form method="post" class="form_second" action="district_query.php" name="country">
...
<? fillcombo("select id,title from tbldating_state_master where currentstatus=0","","Select State"); ?>
</select>
</div>
...
$fromqry = " from tbldating_district_master where currentstatus in (0,5) ";
$fromqry .= $searchqry;
$FileNm = "districtmanager.php?";
...
$result = getdata("select id,title ". $fromqry ." order by tbldating_district_master.title ". $NoOfRecord);
		 ...
		 ?>
            ...
            <td>
				<?
					if($location_mgmnt_lc_2 == 'Y' || $location_mgmnt_lc_2 == 'N') {
				?>
		    	<a href="districtmaster.php?b=<?= $LocationId ?>" class="actionbtn_m green">Modify</a>
				<? } if($location_mgmnt_lc_4 == 'Y' || $location_mgmnt_lc_4 == 'N') {  ?>
				<a href="districtdelete.php?b=<?= $LocationId ?>" class="actionbtndel">Delete</a>
				<? } ?>
            	</td>
            </tr>
		<?
