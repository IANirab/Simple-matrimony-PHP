...
<div class="pagewrapper">
	<div class="container">
		...
		<div class="col-lg-9 center_right">
			<div id="center-in">
        <h1 class="pagetitle">Update Profile Cron Help
			...
			<div class="addlink1">	
                ...
                <a href="cron_update_profile.php">Run File</a>
                </div>
			</div>
			<!-- ********* TITLE END HERE *********-->
			<div id="pagecontent">
...
<ul>
<li>1. Check User Login Activity</li>
<li>2. If User Cant Login Untill 20 Days, Sent Reminder Email</li>
<li>3. Get Entry in DataBase </li>
<li>4. Send Email </li>
<li>5. Can't Send repeat mail within 20 days, After 1 mail sent (if user still not login)</li>
</ul>
</div>
<div class="cron_help_text">			
<h1>File Name</h1>
<ul>
<li><i>cron_update_profile.php</i></li>
</ul>
</div>
...
<ul>
<li>
1.Cron File, Send Email, if user not login no. of days<br>
Control from -> tbldatingsettingmaster (profile_reminder)</li>
<li>
2. Cron File, Send Email at once 200 Users <br/>
Control from -> cron_update_profile.php ($limit)</li>
<li>
3. Cron File, Can't Send repeat mail within 20 days, After 1 mail sent (if user still not login)<br>
Control from -> cron_update_profile.php ($send_again)</li>
<li>
4. Cron File, use email template <br>
Control from -> tbldatingemailmaster (emailid=17)</li>
<li>
5. Cron File, Entry of Email<br> 
See in  -> tbl_cron_master_new (type=1)</li>
</ul>
</div>
</div>
