...
<div class="pagewrapper">
	<div class="container">
		...
		<div id="center-in">
			<!-- ********* TITLE START HERE *********-->
			<h1 class="pagetitle" > <i class="fas fa-american-sign-language-interpreting"></i> Members Avaiable for Handpicks
		<!-- CENTER END ######################## -->
	</div>	
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
    <li>
    <a href="addhandpicked.php?b=<? echo $data->userid; ?>" class="hvr-rectangle-out"> <i class="fas fa-share-square"></i> Send Handpick</a>
    </li>
    </td>
    </tr>
    <? } ?>
