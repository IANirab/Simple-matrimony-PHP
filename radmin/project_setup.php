...
$new_link ='https://www.communitymarriages.com/';
$old_link ='www.communitymarriages.com/';


$old_link1='http://www.communitymarriages.com/';
$old_link2='http://90.0.0.8/work2015/demomatrimony/';
...
for($i=0;$i<count($tbl_name);$i++)
{
	...
	while($rs= mysqli_fetch_array($result))
	{
		...
		$get_newlink=str_replace($old_link1,$new_link,$get_newlink);
		$get_newlink=str_replace($old_link2,$new_link,$get_newlink);
