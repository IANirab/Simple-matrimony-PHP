<!-- ********* TITLE START HERE *********-->
    ...
    <div class="col-xs-12 col-sm-2 col-md-5 col-lg-10 midle_title"><span><?= $viewedmyprofile_listviewedmyprofile ?></span></div>
     <div class="col-xs-2 col-sm-5 col-md-5 col-lg-1 hidden-md trac_top">&nbsp;</div>
    </div> 
 </div> 
...
<?
		...
		$imagenm = find_user_image($userid,"","","");
			?>
                ...
                <? } if($religionid != ''){?>
                	<strong><?= $express_intrest_receivedhead05 ?></strong> <?= $religionid ?><br />
