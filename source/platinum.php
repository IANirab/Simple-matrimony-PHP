...
<head>
    ...
    <title>Platinum :: Paroshi.com</title>
    <!-- Custom CSS -->
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> Platinum Club</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<div class="row el-element-overlay">
        ...
        $curruserid1 = 63;
        $db = new mysqli("localhost","paroshic_paroshic","kxmcwQzLTrTR","paroshic_matri2018jl");
        $sql = "select * from tbldatingusermaster where packageid='$curruserid1'";
        $result = $db->query($sql);
