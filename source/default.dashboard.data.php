...
<div class="pagetitle">
    ...
    <div class="col-xs-12 col-sm-2 col-md-5 col-lg-4 midle_title"><span><?= $dashboardwelcome ?> <?= getusername(); ?></span></div>
     <div class="col-xs-2 col-sm-5 col-md-5 col-lg-4 hidden-md trac_top">&nbsp;</div>
    </div>
</div>
...
WHERE CurrentStatus =0 AND FromUserId=$curruserid AND Subject IN (Select title from tbldatingwinkmaster where currentstatus=0)");
		...
		?>      
        <!-- End -->
<div class="errorbox errorbox3" style="margin-bottom:10px;"><span><?= $expmess ?></span></div>
<div class="errorbox errorbox3" style="margin-bottom:15px;"><span><?php checkerror(); ?></span></div>
...
<div class="dasLastlogin">
	<strong><?= $dashboard_current_login_ip ?> : <?= getip() ?> |
    <?=$dashboard_lastlogin?>:<?=$lastlogin?></strong>
</div>
...
<div class="dashboardphoto">
<span><a href='<?= $ownprofilelink ?>' target="_blank"><?= $imagenm ?></a></span>


<div class="same_profiles1">
<h5>
<?= $dashboardmyprofileid ?>  <?= display_profile_code($curruserid) ?></h5>
...
<i>
<a href='<?= $ownprofilelink ?>' target="_blank"><img src="<?=$sitepath?>assets/<?=$sitethemefolder?>/images/displayprofileicon1.png" alt="" /> <?=$dashboardviewmyprofile ?></a>
</i>
<? } ?>
<i>
<a href='album.php?b=<?= $curruserid?>' target="_blank" class="icon_album"><img src="<?=$sitepath?>assets/<?=$sitethemefolder?>/images/albumicon1.png" alt="" /> <?=$dashboardviewalbum ?></a>
</i>
</div>
...
<div class="dashboardannouncement">
<h4><?= $announcementhead ?></h4>
</div>
<div class="dashboard_profile_stuttas_main">
<div class="dashboard_profile_tital"><?=$profilestatushead?></div>
<div border="0" class="profilestatus">
    ...
    <div class="dashboard_profile_txt"><?= $dashboard_profile_complete_mess1 ?> <?= $profile_percentage ?>% <?= $dashboard_profile_complete_mess2 ?>
    </div>
</div>
...
?>
<?php /*?><div class="dashboardmessenger"><img src="<?= $siteimagepath ?>images/messengerbtn.png" alt="" <?=$chatonclick?> /></div><?php */?>

<?php /*?><div class="dashboardselfprofile_2"><a href="updateprofilepicture2.php"><?=$dashboard_manage_photos ?></a></div><?php */?>
<?php /*?><div class="dashboardselfprofile"><a href='<?= $ownprofilelink ?>' target="_blank"><?= $dashboardviewmyprofile ?></a></div><?php */?>
</div>
...
if ($totalnewmessage == 0)
	...
	$clsnm = "newmessage1";
?>
<?php /*?><div class="newmessage"><div class="<?= $clsnm ?>"><span><?= $dashboardtotalnewmessage ?></span> <a href='<?= $sitepath ?>pmbmanager.php?goto=Inbox'><?= $totalnewmessage ?></a></div><?php */?>
...
<?php /*?><div class="dashboardtotalexpressinterest"><span><?= $dashboardtotal_express_intrest_pending ?>:</span> <a href='<?= $sitepath ?>express_intrest_received.php'><?= express_intrest_pending($curruserid) ?></a></div><?php */?>
<? //check_weather_to_display_trust_seal_banner($curruserid) ?>
<?php /*?><div class="dashboarddata1">
<span><?= $dashboardtotal_contact_view ?> </span> 
<a href='<?= $sitepath ?>contact_viewd_master.php'><?= $total_contact_can_view ?></a></div><?php */?>

<?php /*?><div class="dashboarddata2 lefter_dash">
...
<?php /*?><div class="dashboarddata3 lefter_dash"><span class="design_block"><label><?= $dashboard_web_messagner_online_1 ?> <?= $total_messager_contact ?> <?= $dashboard_web_messagner_online_2 ?> </label><b> <?= $total_messager_contact_online ?></b></span> </div><?php */?>

<div class="dashboardbottommembers">
<div>
</div>
</div>
<br />
...
<a href="<?= $sitepath ?>updateprofilepersonal.php">
<img src="<?= $siteimagepath ?>images/iconupdateprofile.png" alt="">
<span><?= $dashboardprofiles  ?></span></a>
<? } ?>

<? if ($Update_profile_Pages_design_setting == "S") { ?>
<a href="<?= $sitepath ?>registration2.php"><img src="<?= $siteimagepath ?>images/iconupdateprofile.png" alt="">
<span><?= $dashboardprofiles  ?></span></a>
<? } ?>
</div>
...
<div class="dashboardbox1">
<a href="<?= $sitepath ?>updateprofilepicture2.php">
<img src="<?= $siteimagepath ?>images/profile_pic_icon.png" alt="">
<span><?= $dashboardprofilepicture ?></span></a>
</div>
...
<div class="dashboardbox1">
<a href='<?= $sitepath ?>favoritemanager.php'><img src="<?= $siteimagepath ?>images/iconfavorite.png" alt="">
<span><?= $dashboardmyfavorite ?></span></a></div>





<div class="dashboardbox1"><a href='<?= $sitepath ?>albummaster.php'><img src="<?= $siteimagepath ?>images/iconalbum.png" alt="">
<span><?= $dashboardalbummanager ?></span></a>
</div>



<div class="dashboardbox1">
<a href="<?= $sitepath ?>notify.php">
<img src="<?= $siteimagepath ?>images/in_out_icon.png" alt="">
<span><?= $dashboardInbox ?></span></a>
</div>




<div class="dashboardbox1"><a href='<?= $sitepath ?>packagemanager.php'><img src="<?= $siteimagepath ?>images/iconpackagemanager.png" alt="">
<span><?= $dashboardpackagemanager ?></span></a></div>


<div class="dashboardbox1"><a href='<?= $sitepath ?>invoicemanager.php'><img src="<?= $siteimagepath ?>images/iconinvoicemanager.png" alt="">
<span><?= $dashboardinvoicemanager ?></span></a></div>



<div class="dashboardbox1"><a href='<?= $sitepath ?>search_crieteria_manager.php'><img src="<?= $siteimagepath ?>images/iconsearchcrieteriamanager.png" alt=""><span><?= $dashboard_search_criteria ?></span></a></div>


<div class="dashboardbox1"><a href='<?= $sitepath ?>viewedothercontacts.php'>
<img src="<?= $siteimagepath ?>images/viewedBYcontact_icon.png" alt="">
<span><?=$dashborad_stats2_memberscontactsviewedbyme?>(<?=$msg_2 ?>)</span></a></div>

<div class="dashboardbox1"><a href='<?= $sitepath ?>notify_analytics.php'><img src="<?= $siteimagepath ?>images/Analytics_icon.png" alt="">
<span><?=$dash_analytic?></span></a></div>
...
<div class="dashboardbox1"><a href='<?= $sitepath ?>viewedmycontact.php'>
<img src="<?= $siteimagepath ?>images/viewedcontact_icon.png" alt="">
<span><?=$dashborad_stats2_membersviewedmycontacts?>(<?=$msg_1 ?>)</span></a></div>



<div class="dashboardbox1"><a href='<?= $sitepath ?>viewedmyprofile.php'>
<img src="<?= $siteimagepath ?>images/viewedmyProfile_icon.png" alt="">
<span><?= $dashborad_stats2_membersviewedmyprofile?>(<?=$msg_3 ?>)</span></a></div>

<div class="dashboardbox1"><a href='<?= $sitepath ?>viewedotherprofiles.php'>
<img src="<?= $siteimagepath ?>images/viewedmyuser_icon.png" alt="">
<span><?= $dashborad_stats2_membersviewebyme ?>(<?=$msg_4 ?>)</span></a></div>



<div class="dashboardbox1"><a href='<?= $sitepath ?>privacy_settings.php'><img src="<?= $siteimagepath ?>images/iconprivacy_settings.png" alt="">
<span><?=$left_privacysettings?></span></a></div>

<div class="dashboardbox1"><a href='<?= $sitepath ?>signout.php'><img src="<?= $siteimagepath ?>images/iconlogout.png" alt="">
<span><?= $dashboardlogout ?></span></a></div>
