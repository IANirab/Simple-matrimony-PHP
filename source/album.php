...
<!-- ============================================================== -->
    ...
    position: relative;
    top: 14px;
    left: 23px;" src="https://www.paroshi.com/uploadfiles/site_default5/sitelogo.png" class="light-logo" />
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Galary</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="<?= $sitepath ?>uploadfiles/thumbalbum<?= $imagenm ?>" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="<?= $sitepath ?>uploadfiles/album<?= $imagenm ?>"><i class="mdi mdi-magnify-plus"></i></a></li>
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="javascript:void(0);"><i class="mdi mdi-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                                    <h4 class="m-b-0">Images</h4> <span class="text-muted"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                     <? } ?>
                     <? }else{ ?>
                     <h4>Empty !! No Photos Are Here</h4>
                       <? } ?>
                        <? }?>
