...
<head>
    ...
    <title>Profile Of this Week :: Paroshi.com</title>
    <!-- Custom CSS -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Profile's of the Week</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Profile's of the Week</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
?>
    ...
    <div class="col-lg-3 col-md-6">
            ...
            <div class="el-card-avatar el-overlay-1"> 
                <img src="uploadfiles/<? echo $data1->imagenm; ?>" alt="user">  
                        <div class="el-overlay">
                            <ul class="list-style-none el-info">
        ...
        ?> 
        <a href="https://www.paroshi.com/displayprofile.php?b=<? echo $data1->userid; ?>"><h4 class="m-b-0"><? echo $arr[0].'</a> <i class="fas fa-lock" data-toggle="tooltip" data-placement="right" title="Full Name is Avaiable For Prenium Members">
</i> '; ?></h4>
