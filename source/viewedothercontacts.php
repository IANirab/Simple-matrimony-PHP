...
<head>
    ...
    <title>Viewed Other Contacts :: Paroshi.com</title>
    <!-- Custom CSS -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">MY CONTACTS</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">MY CONTACTS</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
		...
		$dt = $rs[22];
			?>
                ...
                <tr>
                    ...
                    <td>
                        <? if($name != ''){ ?>
					<b><?= $express_intrest_receivedhead01 ?></b> <?= $name?> [ <?= $profile_code ?> ]<br />
                <? } if($age != '' && $heightid!= ''){?>
                ...
                <? } if($religionid != ''){?>
                	<b><?= $express_intrest_receivedhead05 ?></b> <?= $religionid ?></div><div class="gritem_r"> 	
                <? } if($city != ''){?>
