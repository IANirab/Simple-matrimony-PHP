...
<div class="col-lg-8 col-md-9 col-sm-12 col-xs-12">
	<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 top_uddatebanner pull-left">
    <? 
$objbottombanner = new banner();
echo ($objbottombanner->Showbanner1(3));
?>
    </div>
...
{
			?>
            <a href="<?= $sitepath ?>signout.php" ><img src="<?=$sitepath?>assets/<?=$sitethemefolder?>/images/login.png"/> <?=$top_logout?></a>
               <a  href="<?= $sitepath ?>dashboard.php"><img src="<?=$sitepath?>assets/<?=$sitethemefolder?>/images/login.png"/> <?=$top_dashboard?></a>
            <?
}else
{
	?>
    <a  onclick="login_data(this.id)"><img src="<?=$sitepath?>assets/<?=$sitethemefolder?>/images/login.png"/> <?=$top_login?></a>
    	<?
...
{
			   ?>
 <a  onclick="register_data(this.id)"> <img src="<?=$sitepath?>assets/<?=$sitethemefolder?>/images/sign.png"/>
  <?=$signup?></a>
    <?
}
?>
    ...
    <?
		...
		<ul>
        	<li><a target="_blank" href="<?=findsettingvalue("fblink")?>" class="social"></a></li>
            <li><a target="_blank" href="<?=findsettingvalue("twitter_link")?>" class="social social1"></a></li>
            <li><a target="_blank" href="<?=findsettingvalue("gplus_link")?>" class="social social2"></a></li>
            <li><a target="_blank" href="<?=findsettingvalue("linkedin_link")?>"class="social social3"></a></li>
        </ul>  
	</div>	
...
<? if($enable_language=='Y'){ ?>
	<div class="SelectBox">
    <select class="selectpicker" onchange="set_language(this.value)">
        <option value="0.0">Select Language</option>
        <option value="eng" <? if($lang_val=='eng'){ ?> selected="selected" <? } ?>>English</option>
<?php /*?>        <option value="mrt" <? if($lang_val=='mrt'){ ?> selected="selected" <? } ?>>Marathi</option><?php */?>
        <option value="bn" <? if($lang_val=='bn'){ ?> selected="selected" <? } ?>>Bengali</option>
    </select>
	</div>
