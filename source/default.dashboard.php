...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="assets1/images/favicon.png">
    <title>Paroshi.com :: Dashboard</title>
    <!-- Custom CSS -->
...
?>
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-6 col-lg-4 col-xlg-3">
                        ...
                        <div class="card card-hover">
                            <div class="box bg-success text-center">
                                <h1 class="font-light text-white"><i class="m-r-10 mdi mdi-account-star-variant"></i></h1>
                                <h6 class="text-white">Find Matches</h6>
                            </div>
                        </div>
                        </a>
                    </div>
                      ...
                      <a href="badges.php">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                <h1 class="font-light text-white"><i class="far fa-bookmark"></i></h1>
                                <h6 class="text-white">Premium badges</h6>
                            </div>
                        </div>
                        </a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                      <a href="<?= $sitepath ?>favoritemanager.php">
                        <div class="card card-hover">
                            <div class="box bg-cyan text-center">
                                <h1 class="font-light text-white"><i class="m-r-10 mdi mdi-account-multiple-outline"></i></h1>
                                <h6 class="text-white">Manage Favorites</h6>
                            </div>
                        </div>
                      </a>
                    </div>
                    <!-- Column -->
                      <div class="col-md-6 col-lg-2 col-xlg-3">
                        <a href="<?= $sitepath ?>packagemanager.php">
                        <div class="card card-hover">
                            <div class="box bg-success text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-calendar-check"></i></h1>
                                <h6 class="text-white">My Packages</h6>
                            </div>
                        </div>
                        </a>
                    </div>
                     <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <a href="<?= $sitepath ?>invoicemanager.php">
                        <div class="card card-hover">
                            <div class="box bg-warning text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-collage"></i></h1>
                                <h6 class="text-white">My Billing</h6>
                            </div>
                        </div>
                        </a>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <a href="<?= $sitepath ?>search_crieteria_manager.php">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                <h1 class="font-light text-white"><i class="m-r-10 mdi mdi-account-search"></i></h1>
                                <h6 class="text-white">My Saved Seach Criteria</h6>
                            </div>
                        </div>
                        </a>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <a href="<?= $sitepath ?>viewedotherprofiles.php">
                        <div class="card card-hover">
                            <div class="box bg-info text-center">
                                <h1 class="font-light text-white"><i class="fas fa-eye"></i></h1>
                                <h6 class="text-white">My Views -<?=$msg_4 ?></h6>
                            </div>
                        </div>
                        </a>
                    </div>
                    ...
                    <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <a href="<?= $sitepath ?>albummaster.php">
                        <div class="card card-hover">
                            <div class="box bg-warning text-center">
                                <h1 class="font-light text-white"><i class="far fa-image"></i></h1>
                                <h6 class="text-white">Manage Album</h6>
                            </div>
                        </div>
                        </a>
                    </div>
                    ...
                    <!-- Column -->
                    <div class="col-md-6 col-lg-4 col-xlg-3">
                        <a href="<?= $sitepath ?>viewedmyprofile.php"
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                <h1 class="font-light text-white"><i class="far fa-smile"></i></h1>
                                <h6 class="text-white">Users Who Viewed My Profile -<?=$msg_3 ?></h6>
                            </div>
                            </a>
                    </div>
                    ...
                    <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <a href="<?= $sitepath ?>viewedmycontact.php">
                        <div class="card card-hover">
                            <div class="box bg-info text-center">
                                <h1 class="font-light text-white"><i class="far fa-eye-slash"></i></h1>
                                <h6 class="text-white">Users Who Viewed My Contact -<?=$msg_1 ?></h6>
                            </div>
                        </div>
                        </a>
                    </div>
                     <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <a href="<?= $sitepath ?>viewedothercontacts.php">
                        <div class="card card-hover">
                            <div class="box bg-cyan text-center">
                                <h1 class="font-light text-white"><i class="far fa-address-card"></i></h1>
                                <h6 class="text-white">My Contacts -<?=$msg_2 ?> </h6>
                            </div>
                        </div>
                        </a>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <a href="<?= $sitepath ?>privacy_settings.php">
                        <div class="card card-hover">
                            <div class="box bg-success text-center">
                    ...
                    <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <a href="<?= $sitepath ?>notify_analytics.php">
                        <div class="card card-hover">
                            <div class="box bg-warning text-center">
    ...
    <!-- Charts js Files -->
    <script src="assets1/libs/flot/excanvas.js"></script>
    <script src="assets1/libs/flot/jquery.flot.js"></script>
    <script src="assets1/libs/flot/jquery.flot.pie.js"></script>
    <script src="assets1/libs/flot/jquery.flot.time.js"></script>
    <script src="assets1/libs/flot/jquery.flot.stack.js"></script>
    <script src="assets1/libs/flot/jquery.flot.crosshair.js"></script>
    <script src="assets1/libs/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
