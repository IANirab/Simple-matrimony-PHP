...
<head>
    ...
    <title>Saved Searches :: Paroshi.com</title>
    <!-- Custom CSS -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">MY SAVED SEARCHES</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">MY SAVED SEARCHES</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
?>
                        <tr>
                            ...
                            <td><?= $createdate?>&nbsp;</td>
                            <td>
                                <a href="<?= $sitepath ?>search_criteria_query.php?b=<?= $criteria_id?>">
                                <b><i class="fas fa-search"></i> Search Now</b>
                                </a>
                                <br>
                                <br>
                                <a href="<?= $sitepath ?>search_criteria_delete.php?b=<?= $criteria_id?>">
