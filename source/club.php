            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Elite Club</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Find Partners</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<div class="row el-element-overlay">
        ...
        $curruserid1 = 64;
        $db = new mysqli("localhost","paroshic_paroshic","kxmcwQzLTrTR","paroshic_matri2018jl");
        $sql = "select * from tbldatingusermaster where packageid='$curruserid1' limit 4";
        $result = $db->query($sql);
...
<span class="text-muted">From <? echo $data->address; ?> </span>
<? } ?>
...
<div style="text-align:center;" class="col-md-4">
    <a href="eliteclub.php"><button type="button" class="btn btn-primary btn-sm"> See More....</button></a>
</div>
<div class="col-md-4">
...
<h4 class="page-title">Platinum Club</h4>
<div class="row el-element-overlay">
...
<? } ?>
    ...
    <? 
        ...
        while($data2 = $result2->fetch_object()){
    ?>
        <span class="text-muted"> <? echo $data2->title ?>
      <? if($data->company_name != NULL) {?>
      at <? echo $data->company_name; ?>
      <? } ?> </span>
...
<? } ?>
     ...
     <? 
        $curruserid2 = $data->countryid;
        $db2 = new mysqli("localhost","paroshic_paroshic","kxmcwQzLTrTR","paroshic_matri2018jl");
        $sql2 = "select * from tbl_country_master where id='$curruserid2'";
        $result2 = $db2->query($sql2);
        
        while($data2 = $result2->fetch_object()){
    ?>
    <span class="text-muted"> <? echo $data2->title; ?> </span>
<? } ?>
...
<div style="text-align:center;" class="col-md-4">
    <a href="platinumclub.php"><button type="button" class="btn btn-primary btn-sm"> See More....</button></a>
</div>
<div class="col-md-4">
...
<h4 class="page-title">Gold Club</h4>
...
<div style="text-align:center;" class="col-md-4">
    <a href="goldclub.php"><button type="button" class="btn btn-primary btn-sm"> See More....</button></a>
</div>
<div class="col-md-4">
