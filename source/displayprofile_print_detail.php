...
<link href="assets/<?=$sitethemefolder?>/webstyle.css" rel="stylesheet" type="text/css" />
...
<div class="display_printer">
<div class="printtitle"><h1>
 <? if(findsettingvalue('display_user_name')=='Y'){?>
					  <?=$name?> &nbsp;
                       <?  }else{?> 
                       <?=display_name_roundc($name)?>		
                       <? } ?>
<?= $displayprofileprofile_code ?><?=$profile_code ?><span style="float:right;"><a href="#" onclick="javscript:window.print();"><?= $directorydisplay_print_detail_print ?></a></span></h1></div>
<div class="printsubtitle">

</div>
<? if($imagenm!="") { ?>
<div class="mainphoto"><img src="<?= $sitepath ?>uploadfiles/<?=$imagenm?>"></div>
...
<? }else{ ?>
	<?
     ...
     if($genid==1)
     { ?>
     <div class="mainphoto"><img src="<?= $sitepath ?>uploadfiles/maleimage.png" height="133" width="100" border="0" ></div>
    <? } ?>	 
    
    <? if($genid==2)
     { ?>
   <div class="mainphoto"><img src="<?= $sitepath ?>uploadfiles/femalenoimage.png" height="133" width="100" border="0" ></div>
    <? } ?>	 
...
<table width="612" border="0" cellspacing="0" cellpadding="0" class="printmaintable">
  <tr>
    <td width="300" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td scope="row"><table width="261" border="0" cellspacing="0" cellpadding="0" class="printinnertable">
          <tr>
      ...
      <table width="261" border="0" cellspacing="0" cellpadding="0" class="printinnertable">
              <tr>
                <td colspan="2" scope="row"><h4 class="highlight_topic">
                  <?= $displayprofilehead5 ?>
                </h4></td>
    ...
    <td width="312" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table width="261" border="0" cellspacing="0" cellpadding="0" class="printinnertable">
         ...
         <? if ($denomination_val != "" && $religianid=='Christian' && $denomination_module=='Y'){?><tr>
            <td scope="row"><span><?= str_replace(":","",$denomination_lable) ?>:</span></td> 
            <td scope="row"><span><?= $denomination_val ?></span></td>
          </tr>
		<? } ?>
        
        <? if ($catholicyn != "" && $religianid=='Christian' && $catholic_module=='Y'){?>
		<tr>
            <td scope="row"><span><?=$updateprofile2catholicque ?>:</span></td> 
            <td scope="row"><span><?= $catholicyn ?></span></td>
          </tr>
		<? } ?>
           ...
           <? if ($silsila != "") { ?>
		<tr>
            <td scope="row"><span>Silsila:</span></td> 
            <td scope="row"><span><?= $silsila ?></span></td>
          </tr>
		<? } ?>
          <? if ($motherthoungid != "") { ?>
  ...
  ?>
  <tr>
    <td colspan="2" align="left" valign="top" style="padding-top:0px;">
    <table width="418" border="0" cellpadding="0" cellspacing="0" class="printinnertable">
      <tr>
        <td colspan="2" scope="row"><h4 class="highlight_topic">
...
while($rsinterest= mysqli_fetch_array($interestqrye)){ 
  ...
  <table width="418" border="0" cellpadding="0" cellspacing="0" class="printinnertable externals" style="margin-top:5px;">
      <tr>
        <td colspan="2" scope="row"><h4 class="highlight_topic">
          <?= $displayprofileother ?>
        </h4></td>
      ...
      <tr>
        <td scope="row" colspan="2"><span>
          <div style="height:20px; color:#D03B01; line-height:20px;"><?= $displayprofilepersonality ?></div>
          <?= $personality ?>
        </span></td>
      </tr>
      <? } ?>
      ...
      <tr>
        <td scope="row" colspan="2"><span>
          <div style="height:20px; color:#D03B01; line-height:20px;"><?= $displayprofilefamilybackground ?></div>
          <?= $familybackground ?>
        </span></td>
      </tr>
      <? } ?>
      ...
      <tr>
        <td colspan="2" scope="row"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <table width="308" border="0" cellspacing="0" cellpadding="0" class="printinnertable" style="margin-left:0px; border-left:1px solid #999999;">            
              <tr>
            ...
            <td width="47%" height="44" align="left" valign="top" style="border:0px solid #999999;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:1px solid #999999; border-top:1px solid #999999;">
          ...
          <tr>
            <td align="left" valign="top" style="border:0px solid #999999;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:1px solid #999999; border-top:1px solid #999999;">
...
<table width="" border="0" cellpadding="0" cellspacing="0" class="printinnertable externals" style="margin-top:10px; margin-bottom:10px;">
      <tr>
        ...
        <td scope="row" colspan="3"><span>
          <? if ($partner_heightfrom != "") { ?><span><?= $partner_heightfrom ?></span><? } ?>
          <? if ($partner_heightto != "") { ?><span>To &nbsp;<?= $partner_heightto ?></span><? } ?></span></td>
        </tr>
      ...
      <tr>
        <td scope="row"><span>
          <?= str_replace(":","",$default_displayprofile_annualincome."(".  $annual_income_currancyid_new.")") ?>
        </span></td>
        <td scope="row" colspan="3"><span>
          <?= $partner_annincome ?>
        </span></td>
